...
const faqStructuredData =
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "description": "Explore premium 2 BHK, 3 BHK, and 4 BHK flats in Thrissur by CIDBI. Ready-to-occupy and ongoing apartments available in top localities like Viyyoor and Punkunnam. Ideal for families, investors, and professionals looking for quality living and value.",
      "provider": {
        "@type": "Organization",
        "name": "CIDBI",
        "url": "https://cidbi.com",
      ...
      "offers": [
        {
          "@type": "Offer",
          "name": "CIDBI Cassia",
          "description": "Ongoing smart apartments in Viyyoor, Thrissur. 2, 3 & 4 BHK flats from ₹71.85 lakhs with 40+ amenities.",
          "priceCurrency": "INR",
          "price": "7185000",
    ...
    },
    {
      ...
      "url": "https://cidbi.com",
      "logo": "https://cidbi.com/assets/images/logo.png",
      "description": "CIDBI is a leading real estate builder in Thrissur offering premium apartments and flats designed for modern families. Known for smart home features, prime locations, and on-time delivery, CIDBI helps buyers find flats in Thrissur that match both comfort and value.",
      "areaServed": {
        "@type": "Place",
