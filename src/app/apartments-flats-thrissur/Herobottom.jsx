        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center -mt-[120px] mb-8 md:mb-12">
            <p className="text-white text-[13px] font-normal xl:max-w-5xl md:text-[14px] md:max-w-2xl font-[general-sans-regular] leading-relaxed  mx-auto">
              ...
              Welcome to your new life in the cultural heart of Kerala. Discover
              your dream home. CIDBI builds apartments and flats for sale in
              Thrissur that blend modern comfort with absolute peace of mind. We
              offer stunning flats for sale to easily match your family's unique
              needs. If you are searching for premium apartments, whether it is
              a compact 2 BHK Flat or spacious 3BKH apartment, we have the
              options for you in Thrissur. <br /> Apartment living in Thrissur offers a
              perfect blend of rich culture and modern convenience. Families
              love the peaceful neighbourhoods, premium amenities, and strong
              community vibe. If you want flats for sale in Thrissur, our
              ongoing project, CIDBI Cassia project is an excellent choice.
              Cassia features beautifully designed 2, 3 and 4 BHK smart homes
          ...
          <div className="flex gap-4 justify-center items-center text-[14px] font-[general-sans-regular] font-normal">
            <Link
              href={"/about-us"}
              className="bg-white text-gray-800  py-3 rounded-lg text-[14px] font-medium hover:bg-gray-100 transition-colors duration-200 flex items-center w-full xs:max-w-[210px]  justify-center"
            >
              Enquire Now
              <svg
                className="w-4 h-4"
            ...
            <Link
              href={"/about-us"}
              className="border-2 text-center border-white text-white  py-3 rounded-lg font-medium hover:bg-white hover:text-gray-800 transition-colors duration-200 w-full xs:max-w-[210px] "
            >
              About Us
            </Link>
          </div>
