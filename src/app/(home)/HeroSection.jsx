...
function HeroSection() {
   ...
   const [activeIndex, setActiveIndex] = useState(0);
    ...
    return (
        <>
            <section
                className="h-[605px]  md:h-[540px] lg:h-[860px] -mt-[78px] lg:-mt-[95px] bg-cover bg-center"
                style={{ backgroundImage: `url(/images/home/bg.webp)` }}>
                <div className='h-full md:w-[90%] res lg:w-[80%] mx-auto flex flex-row justify-between md:items-center'>
                    ...
                    <div className='md:block hidden md:h-[430px] lg:h-[591px] md:w-[400px] md:mt-10 lg:mt-0 lg:w-[539px]'>
                        <Carousel
                            loop
                            autoplay
