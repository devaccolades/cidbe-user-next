...
function NotFound() {
  ...
  return (
    <>
      <Header />
      <section className="h-full py-20 2xl:py-40 w-full bg-[b9e1f5] flex flex-col justify-center gap-[16px]">
        <Image
          src={notfoundIcon}
          alt="flats in Thrissur"
          className="mx-auto px-[30px]"
        />
        <Image
          src={connectionIcon}
        ...
        <div className="flex  flex-col justify-center px-[10px] items-center w-full gap-[10px]">
          <p className="text-[24px] font-[general-sans-semibold]">
            Page Not Found
          </p>
          <p className="text-[16px] text-[#77707F] font-[general-sans-regular] text-center lg:w-[30%]">
        ...
        <div className="flex justify-center items-center px-[20px]">
          <button
            onClick={() => router.push("/")}
            className="text-white bg-[--secondary-cl] text-[16px] rounded-[40px] h-[55px] w-[400px]"
          >
            Go back Home
          </button>
        </div>
