...
function Skelten() {
  return (
    <section className='flex md:w-[90%] lg:w-[70%] justify-center mx-auto gap-20 py-20'>
      <div class="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96 animate-pulse">
        ...
        <div class="p-6 pt-0">
          <button disabled="" tabindex="-1"
            class=" select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg text-white shadow-gray-900/10 hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none h-8  bg-gray-300 w-full shadow-none hover:shadow-none"
            type="button">
            &nbsp;
          </button>
        </div>
