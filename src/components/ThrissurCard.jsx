...
export default function ThrissurCard({ project, basePath = '/featured-projects' }) {
  ...
  return (
    <>
      ...
      <Card
        ...
        className='  w-full min-h-[638px] cursor-pointer card-animation bg-white rounded-[15px] overflow-hidden p-[5px] grid grid-rows-[auto_auto_auto] gap-[10px]'
      >
        <motion.div
        ...
        <div className='flex flex-col justify-between'>
          <div className='flex justify-between items-center pt-[10px] px-[15px]'>
            <div className='font-[general-sans-regular] flex flex-col gap-[6px]'>
              ...
              <p className='capitalize flex gap-[8px]'>
                ...
                <span className='text-[14px] lg:text-[16px] leading-[18px] text-[#767575]'>{project?.location}</span>
              </p>
            </div>
          ...
          <div className='bg-white grid grid-cols-2 gap-[10px] px-[15px] pb-[10px] text-[12px] sm:text-[14px]'>
            <Link href={`${basePath}/${project?.slug}`}>
              <button className='border border-[--secondary-cl] w-full text-[--secondary] py-[7px] px-[8px] rounded-[8px] cursor-pointer'>Read more</button>
            </Link>
            <button
      ...
      {/* Desktop layout */}
      {/* <Card className='hidden md:grid w-full min-h-[400px] cursor-pointer bg-white rounded-[15px] overflow-hidden p-[5px] grid-cols-2 gap-[10px] '>
        <div className='bg-top bg-cover h-full rounded-[10px]' style={{ backgroundImage: `url(${project?.thumbnail})` }} />
        <div className='flex flex-col justify-between '>
          <div className='flex justify-between items-center pt-[10px] px-[15px]'>
            <div className='font-[general-sans-regular] flex flex-col gap-[6px]'>
              <p className='text-[32px] lg:text-[36px] text-black uppercase leading-[36px]'>{project?.name}</p>
            ...
            <p className='capitalize rounded-[8px] font-[general-sans-medium] bg-[--secondary-cl] text-[12px] text-white py-[3px] px-[8px] leading-tight'>{project?.status}</p>
          </div>
