    ...
    <Link href={`/blogs/${blog.slug}`}>
      <Card className='w-full group h-[444px] rounded-[12px] blog-card cursor-pointer transition-all duration-300 ease-in-out transform hover:-translate-y-1'>
        ...
        <div className='p-[24px] flex flex-col gap-[12px]'>
          ...
          <button className='bg-[#EC222A] w-full rounded-[8px] py-[8px] text-white font-[general-sans-regular] text-[14px] flex flex-row gap-[8px] justify-center items-center'>Read more<Image src={arrow_outward} alt='arrow-outward' /></button>
        </div>
      </Card>
    </Link>
  )
