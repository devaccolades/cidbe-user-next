...
function Footer({ backGround = "--primary-cl" }) {
  ...
  return (
    <>
      ...
      <section className={`w-full  mx-auto bg-[${backGround}] pt-[40px]`}>
        <div className="lg:w-[83%] w-[90%] mx-auto xl:p-[40px] lg:p-[20px] md:p-[15px] p-[15px] md:grid md:grid-cols-[70%_1fr] flex flex-col justify-center items-center lg:gap-[60px] md:gap-[20px] border border-[--secondary-cl] rounded-[20px]">
          <div className="pb-5">
            <h3 className="lg:text-[32px] md:text-[24px] text-[20px] leading-[20px] lg:leading-[32px] md:leading-[24px] pb-[10px] font-[general-sans-medium]">
              Need Assistance? Register Complaints here!
            </h3>
            <p className="lg:text-[16px] md:text-[14px] text-[12px] leading-[156%] font-[general-sans-regular] ">
          ...
          <Link href="" className="w-full flex justify-end">
            <button className=" bg-[--secondary-cl] lg:text-[16px] md:text-[14px] text-[12px] text-white flex md:flex-row gap-[8px] text-nowrap py-[7px] xl:px-[30px] lg:px-[15px] md:px-[15px] px-[30px] rounded-[8px] md:items-center  justify-center cursor-pointer">
      ...
      <section
        className={`hidden md:block font-[general-sans-medium] text-[--secondary-cl] bg-[${backGround}] px-[40px] xl:px-[120px] py-[40px] flex flex-col`}
      >
        <div className="w-full flex flex-row h-full flex-wrap lg:flex-nowrap">
          <div className="flex flex-col w-full md:w-[60%] logo-div lg:w-[30vw] gap-[20px]">
            <p className="md:w-7/12 lg:w-9/12 text-[16px] leading-[21px] uppercase">
              Your trusted building partner in Thrissur, shaping the future of
              luxury living with quality construction.
            </p>
            <Link href="/">
            ...
            <div className="flex flex-row gap-[20px] items-center">
              <a
                href="https://www.instagram.com/cidbithrissur/"
                target="_blank"
              >
                {" "}
                <Image
              ...
              <a href="https://www.facebook.com/cidbitsr/" target="_blank">
                {" "}
                <Image src={facebook} alt="facebook-logo" />
              </a>
              <a
                href="https://www.youtube.com/channel/UCyRwiMStzuHNzaRzEGb__jQ"
                target="_blank"
              >
                <Image
                  src={youtube}
          ...
          <div className="flex flex-col md:flex-row lg:flex-col justify-between lg:mt-0 mt-[30px]">
            ...
            <div className="mt-[35px] md:mt-0 lg:mt-[35px] font-[general-sans-medium] w-full md:w-[50%] lg:w-auto">
              ...
              <div className="flex flex-row flex-wrap  items-center gap-[10px] lg:gap-[20px]">
                ...
                <Image
                  src={sbilogo}
                  className="w-[70px] md:w-[75px] h-[75px]"
                  alt="sbi-logo"
                />
                <Image
                  src={credailogo}
                  className="w-[80px] md:w-[90px] h-[90px]"
                  alt="creatai-logo"
                />
                <Image
                  src={bailogo}
        ...
        <div className="flex flex-row flex-wrap mt-[10px] md:mt-[10px] ld:mt-0 md:gap-[10px] justify-center items-center w-full">
          <p className="text-center text-[10px] lg:text-[14px] font-[general-sans-regular] text-[#4C956C] capitalize">
            All Rights reserved by <span className="font-bold">CIDBI</span>{" "}
            Thrissur. {currentYear}{" "}
          </p>
          <p className="text-center text-[10px] lg:text-[14px] font-[general-sans-regular] text-[#4C956C] flex justify-center items-center gap-[10px]">
            <span>Powered by Accolades Integrated</span>{" "}
            <a href="https://accoladesintegrated.com/" target="_blank">
              {" "}
              <Image
                width={10}
                height={10}
      ...
      {/* Foote Mobile */}
      <section
        className={`block md:hidden font-[general-sans-medium] text-[--secondary-cl] bg-[${backGround}] px-[20px] xl:px-[120px] py-[40px] flex flex-col`}
      >
        <div className="w-full flex flex-row h-full flex-wrap lg:flex-nowrap">
