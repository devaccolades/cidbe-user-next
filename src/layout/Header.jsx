  ...
  return (
    <>
      ...
      <header className="main-area sticky top-1 z-50">
        <section
          className={`nav-bar ${bgPrimary ? "bgPrimary" : ""} lg:container ${scrolling ? "bg-white" : "bg-transparent"} transition-all duration-500`}
        >
          <Link href="/">
            <Image src={logo} alt="logo" className="logo cursor-pointer" />
          </Link>
          <div className="lap-navbar">
            <ul
              className={`${scrolling ? "text-[#052D23]" : bgPrimary ? "text-[--secondary-cl]" : "text-white"}`}
            >
              <Link href="/">
                <li
                  className={`${scrolling ? "isscroll" : ""} ${pathname === "/" && "active"}`}
                >
                  Home
                </li>
              </Link>
              <li
                className={`menu-hover relative group ${hovered.about || pathname === "/about-us" || pathname === "/csr" ? "active" : ""}`}
              ...
              >
                ...
                <div className="absolute card flex flex-col gap-[1px] left-[-10%] top-[100%] w-[285px] bg-white shadow-lg rounded-lg invisible group-hover:visible group-hover:translate-y-1 transition-all duration-200 ease-in-out z-10 ">
                  <Link
                    ...
                    className="flip-animate dropdown-item"
                  >
                  ...
                  <Link
                    ...
                    className="flip-animate dropdown-item"
                  >
                    <span data-hover="Completed project">
                      Completed project
                    </span>
                  </Link>
                  <Link
                    ...
                    className="flip-animate dropdown-item"
                  >
                    <span data-hover="Upcoming projects">
                      Upcoming projects
                    </span>
                  </Link>
                  <Link
              ...
              <Link href="/interiors">
                <li className={`${pathname === "/interiors" && "active"}`}>
                  Interiors
                </li>
              </Link>
              <Link href={"/blogs"}>
                <li className={`${pathname === "/blogs" && "active"}`}>Blog</li>
              </Link>
              <Link href={"/achievements"}>
                <li className={`${pathname === "/achievements" && "active"}`}>
                  Achievements
                </li>
              </Link>
          ...
          <div
            className="mobile-navbar cursor-pointer"
            onClick={() => setShowMobileNav(!showMobileNav)}
          >
            <Image
              src={
                scrolling ? menuGreenIcon : bgPrimary ? menuGreenIcon : menuIcon
              }
              alt="menu-icon"
            />
          </div>
          {showMobileNav && (
            ...
            >
              <div
                onClick={() => setShowMobileNav(!showMobileNav)}
                className="absolute top-12 right-11 text-white cursor-pointer"
              >
              ...
              >
                <div className="flex flex-col gap-5 items-center justify-center h-full font-[general-sans-medium]">
                  ...
                  <motion.div
                    ...
                    variants={linkItemVariants}
                    onClick={() =>
                      setdropDown({ project: false, about: !dropDown.about })
                    }
                  >
                    <span className="flex items-center">
                      ...
                      <Image
                        src={
                          dropDown.about ? mobileDropupIcon : mobileDropdownIcon
                        }
                        alt="dropdown icon"
                      />
                    </span>
                    {dropDown.about && (
                      ...
                      >
                        <Link href="/about-us">
                          <p className="cursor-pointer text-[#052D23] font-[general-sans-regular] text-[16px]">
                            Who we are
                          </p>
                        </Link>
                        <Link href="/csr">
                  ...
                  <motion.div
                    ...
                    variants={linkItemVariants}
                    onClick={() =>
                      setdropDown({ about: false, project: !dropDown.project })
                    }
                  >
                    <span className="flex items-center">
                      Projects{" "}
